...
+ (void)showDlgAlert:(NSString *) label {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"" message:label delegate:self  cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
...
+ (void)showDlgAlert:(NSString *) label cancelButtonTitle:(NSString *)str title:(NSString *)tips delegate:(id)delegate{
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:tips message:label delegate:delegate  cancelButtonTitle:str otherButtonTitles:nil, nil];
    [alertView setBackgroundColor:[UIColor clearColor]];
    
    //必须在这里调用show方法，否则indicator不在UIAlerView里面
    [alertView show];
}
+ (void)showDlgAlert:(NSString *) label cancelButtonTitle:(NSString *)str other:(NSString *)other title:(NSString *)tips delegate:(id)delegate{
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:tips message:label delegate:delegate  cancelButtonTitle:str otherButtonTitles:other, nil];
    [alertView setBackgroundColor:[UIColor clearColor]];
