...
- (void)adjustFrame
{
    ...
    if (imageSize.width>ScreenWidth) {
        float scaleX = imageSize.width/ScreenWidth*1.0;
        imageSize = CGSizeMake(imageSize.width/scaleX, imageSize.height/scaleX);
    }
    
    if (imageSize.height>ScreenHeight) {
        float scaleY = imageSize.height/ScreenHeight*1.0;
        imageSize = CGSizeMake(imageSize.width/scaleY, imageSize.height/scaleY);
    }
